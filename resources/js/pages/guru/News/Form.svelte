...
<script lang="ts">
    ...
    import NewsController from '@/actions/App/Http/Controllers/Guru/NewsController';
...
<div class="flex flex-col gap-6 p-4">
    <div class="flex flex-wrap items-start justify-between gap-3">
        <Heading
            ...
            description={editing
                ? 'Hanya berita milik Anda yang bisa diubah di sini.'
                : 'Tulisan Anda masuk ke daftar berita saya.'}
        />
        <Button variant="outline" asChild>
            {#snippet children(props)}
                <Link {...props} href="/guru/news" class={props.class}>
